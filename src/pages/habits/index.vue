  ...
  <div class="main">
    ...
    <el-dialog
      ...
      <div>
        ...
        <div class="habits-add-unit">
          <div class="habits-add-unit-label">数量{{"("+habitsEditItem.unit+")"}}</div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      habitsHover(item) {
        let str=item.title;
        str+="／"+item.target+item.unit+"／";
        str+=item.period==="day"?"每日":"每周";
        str+="／已完成："+item.schedule;
        this.tempName = str;
      },
      habitsHoverOut() {
        this.tempName = ""
